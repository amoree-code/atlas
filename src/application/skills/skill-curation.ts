...
export type SkillCandidate = { id: string; name: string; version: string; instructions: string; status: "candidate" | "rejected" | "promoted"; createdAt: string; sourceSessionId?: string };
