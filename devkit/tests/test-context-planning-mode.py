...
retired the ~/atlas/context/ dispatch mirror this file used to exercise instead; formerly
cut over by T-016). This file tests that live file directly, against a disposable
ATLAS_HOME, so nothing here touches the real workspace.
