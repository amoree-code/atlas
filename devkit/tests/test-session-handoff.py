...
them (not assumed):
  ...
  engine/cli/atlas-context   canonical (--resume lives here; T-118 retired the
                              ~/atlas/context/ dispatch mirror this file used to exercise
                              instead — formerly canonical since T-016)
  engine/cli/atlas-tickets   canonical — tickets are NOT cut over to ~/atlas (confirmed by
                              test-cli-source-drift.py); the pointer writer lives in this
                              repo copy, correctly
