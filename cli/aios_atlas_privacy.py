...
# pre-AIOS-014 paths (`~/.ai-os/user/...`) that no longer exist — private, not yet even
...
EXTENSIONS_FILE_CLASSES = {
    ...
    "skills/graphify/SKILL.md":                    PUBLISHABLE,
    "skills/graphify/.graphify_version":           PUBLISHABLE,
    "skills/graphify/references/add-watch.md":     PUBLISHABLE,
    "skills/graphify/references/exports.md":       PUBLISHABLE,
    "skills/graphify/references/extraction-spec.md": PUBLISHABLE,
    "skills/graphify/references/github-and-merge.md": PUBLISHABLE,
    "skills/graphify/references/hooks.md":         PUBLISHABLE,
    "skills/graphify/references/query.md":         PUBLISHABLE,
    "skills/graphify/references/transcribe.md":    PUBLISHABLE,
    "skills/graphify/references/update.md":        PUBLISHABLE,
