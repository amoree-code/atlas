...
test("profileIdentity changes when any policy field changes", () => {
  const readOnly = validateProfile({
    name: "reviewer",
    provider: "claude",
    model: "sonnet",
    role: "reviewer",
  ...
  const writable = validateProfile({
    name: "reviewer",
    provider: "claude",
    model: "sonnet",
    role: "reviewer",
